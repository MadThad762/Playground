          ...
          <div className='flex min-h-full items-center justify-center p-4 text-center sm:p-0'>
            ...
            >
              <Dialog.Panel className='mx-auto flex h-screen w-screen flex-col items-center justify-center overflow-hidden bg-brand-800 duration-500 ease-out'>
                <div className='relative mx-auto flex h-full w-full max-w-screen-2xl flex-col items-center justify-center px-6 text-brand-300 lg:px-8'>
                  ...
                  <div className='aspect-w-16 aspect-h-11 relative mx-auto flex w-full items-center justify-center'>
                    {image && (
                      <Image
